...
export default function BlogDetailClient({ blog }: Props) {
  return (
    <section className="bg-[#eef1f7] py-12 md:py-16 container">
      <div className="">
...
/> */}
<div
  className="prose max-w-none text-[#5c6b73] leading-relaxed break-words [&_*]:break-words [&_*]:overflow-wrap:anywhere"
  dangerouslySetInnerHTML={{
    __html: normalizeHtml(blog.content?.join("") || ""),
  }}
/>
        </motion.div>
