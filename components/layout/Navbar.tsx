...
const [isCareerOpen, setIsCareerOpen] = useState(false);
 ...
 useEffect(() => {
  ...
  return (
<header
  className="sticky top-0 left-0 w-full z-[9999] border-b transition-all duration-300"
  style={{
...
>
      <div
        className="container mx-auto relative grid grid-cols-3 items-center transition-all duration-300"
    ...
    >
      ...
      >
            ...
            if (item.dropdown === "services") {
              return (
                ...
                >
                  ...
                  >
                    <div className="w-[370px] max-w-[90vw] bg-white shadow-2xl border rounded-xl p-6">
                      {loading ? (
        ...
        <button
          ...
          className="lg:hidden absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10"
        >
          <Hamburger open={open} />
        </button>
      </div>
