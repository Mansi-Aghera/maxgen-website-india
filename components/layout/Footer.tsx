...
//         <div className="grid md:grid-cols-2 lg:grid-cols-[40%_20%_20%_20%]">
//           {/* INFO */}
...
//               <p>
//                 <b>Email:</b> info@maxgentechnologies.com
//               </p>
//               <p>
//                 <b>Phone:</b> 9090939845 / 9998491391
//               </p>
//             </div>

//             <div className="flex gap-3 pt-2 flex-wrap py-3">
//               <Social
...
//         <div className="container py-4 flex flex-col md:flex-row gap-3 md:items-center md:justify-between text-xs sm:text-sm">
//           <div>
...
//       <Link
//         href={href}
//         className="relative block text-sm text-[var(--color-text-muted)] py-1"
//       >
//         <motion.span
//           variants={{
...
>([])
  ...
  return (
    <footer className="border-t bg-[var(--color-bg-light)] border-[var(--color-border)] overflow-hidden">
      {/* TOP */}
      <div className="container py-12">
        <div className="grid grid-cols-1 lg:grid-cols-[40%_20%_20%_20%]">
          ...
          {/* Quick Links + Services — side by side on mobile, normal on lg */}
          <div className="grid grid-cols-2 lg:contents">
            <FooterCol title="Quick Links" links={quickLinks} />
            <FooterCol title="Services" links={services} />
          </div>

          {/* Internships — hidden on mobile, visible on md+ */}
      ...
      {/* BOTTOM */}
      <div className="border-t border-[var(--color-border)]">
        <div className="container py-4 flex flex-col-reverse md:flex-row gap-6 md:items-center md:justify-between text-xs sm:text-sm">
          {/* Copyright - Now appears at bottom on mobile */}
          <div className="text-center md:text-left">
            © 2013 – {new Date().getFullYear()} Maxgen Technologies Pvt. Ltd.
            All Rights Reserved.
          </div>

          {/* Policy Links - Appears above copyright on mobile */}
...
function Social({ href, icon }: { href: string; icon: React.ReactNode }) {
  return (
    <a
      ...
      className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-[var(--color-border)] hover:bg-[var(--color-accent)] transition-colors duration-200"
    >
      <span className="text-[var(--color-text-muted)] hover:text-white transition-colors duration-200">
        {icon}
      </span>
    </a>
  )
