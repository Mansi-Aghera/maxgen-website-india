        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            variants={{
              ...
              visible: {
                transition: {
                  staggerChildren: 0.12, // Reduced from 0.18 for smoother sequence
          ...
          >
            <motion.h1
              ...
              className="text-3xl md:text-4xl lg:text-5xl font-semibold leading-tight text-center lg:text-left break-words"
            ...
            <motion.p
              variants={{
                hidden: { opacity: 0, y: 25 }, // Reduced from 40
                visible: { 
                  opacity: 1, 
                  y: 0,
                  transition: {
              ...
              className="mt-6 text-lg max-w-xl text-center lg:text-left mx-auto lg:mx-0"
            >
              {slide.description}
            </motion.p>
