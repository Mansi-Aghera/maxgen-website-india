...
/>
          ...
          <Button href="/about" variant="primary" size="lg" className="mt-12 mx-auto lg:mx-0">
            ABOUT US
          </Button>
        </motion.div>
...
/>
          ...
          <ul className="mt-8 space-y-4 mx-auto lg:mx-0 w-fit text-left">
            {services.map((item, i) => (
              <motion.li
                key={item.id}
          ...
          <Button href="/services" variant="primary" size="lg" className="mt-12 mx-auto lg:mx-0">
            OUR SERVICES
          </Button>
        </motion.div>
        ...
        <motion.img
          ...
          viewport={{ once: true }}
          transition={{ duration: 1 }}
          className="w-full max-w-[520px] mx-auto lg:mx-0 order-1 lg:order-2"
        />
      </div>
...
<Heading
  className="text-center md:text-center lg:text-left"
  title="Our Internship Offerings"
/>

          <ul className="mt-8 space-y-3 mx-auto lg:mx-0 w-fit text-left">
            {[
              "Python Django",
          ...
          <Button href="/internship" variant="primary" size="lg" className="mt-12 mx-auto lg:mx-0">
            EXPLORE INTERNSHIPS
          </Button>
        </motion.div>
      </div>
