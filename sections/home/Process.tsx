...
export default function Process() {
  return (
    <Section>
      ...
      {/* steps */}
      {/* steps */}
      <div className="mt-20 grid md:grid-cols-3 items-start relative gap-16 md:gap-0">
        ...
        {steps.map((step, i) => (
          <div key={i} className="relative flex flex-col items-center w-full">
            ...
            <motion.div
              ...
              className="w-32 h-32 md:w-40 md:h-40 rounded-full flex items-center justify-center bg-light border border-default shadow-md relative z-10"
            >
              <motion.img
                src={step.icon}
                alt={step.title}
            ...
            <motion.p
              ...
              className="mt-3 text-lg md:text-xl text-center max-w-[160px]"
