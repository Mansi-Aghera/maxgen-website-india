...
//       {/* steps */}
//       <div className="mt-20 grid md:grid-cols-3 items-start">
//         {steps.map((step, i) => (
//   <div key={i} className="relative flex flex-col items-center">

//     {/* connector line */}
//     {i !== steps.length - 1 && (
//       <div className="hidden md:block absolute top-20 left-[calc(50%+80px)] w-[calc(100%-160px)] h-[4px] bg-border-default opacity-100" />
//     )}
